...
## Features
```md
✅ Basic complete and easy to use snippet

✅ Basically a complete restoration of the official RS documentation
...
When you're done,open a folder or code-workspace, open any Lua file, right-click and select "Lua: Open Addons Manager" or Ctrl+P to open the command panel and enter “`>lua.addon_manager.open`”

Wait for the Addons manager to finish fetching plugins from Github (you may need to have git installed locally, you must have connect to Github, then find "Ravenscript IDEA" in the list of plugins and enable it), then enjoy the snippet experience that we bring to you!
...
you have to associate the txt extension with the Lua language in the IDE, so that you can use the Lua extension to develop RS.
...
[![License](https://img.shields.io/badge/AFDIAN-SPONSR US!-lightpurple.svg?style=for-the-badge&)](https://afdian.net/a/Nsrc233)
