import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as a,c as r,a as i,b as e,d as v,e as n}from"./app-JntOLF8T.js";const c={},t=n(`<h1 id="otr-1-rftools杂项" tabindex="-1"><a class="header-anchor" href="#otr-1-rftools杂项" aria-hidden="true">#</a> otr.1 RFTools杂项</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>本文介绍有关RFTools的一些功能、文件目录结构，以及关于其的常见问题等</p><h2 id="rftools的目录结构" tabindex="-1"><a class="header-anchor" href="#rftools的目录结构" aria-hidden="true">#</a> RFTools的目录结构</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>RFTools
